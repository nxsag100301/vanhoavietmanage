  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        {...props}
      >
        <PanelLeft style={{ width: '2rem', height: '2rem' }} />
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        className={cn(
          'flex h-8 shrink-0 items-center rounded-md outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
