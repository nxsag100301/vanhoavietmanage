      ...
      return (
        <div className='relative'>
          <input
            type={type}
            className={cn(
              `flex h-[40px] 3xl:h-[54px] w-full rounded-[12px] 3xl:rounded-[16px] border border-grayneutral-100 bg-text-50 px-6 py-[15px] 
          ...
          {startIcon && (
            <img
              src={startIcon}
              className='absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 3xl:h-6 3xl:w-6'
            />
          )}
        </div>
      )
    ...
    return (
      <div className={cn('relative w-full', className)}>
        <input
          ...
          className={cn(
            `flex h-[45px] 3xl:h-[54px] w-full rounded-[12px] 3xl:rounded-[16px] border border-grayneutral-100 bg-text-50 px-6 py-[15px] 
          text-h5 text-text-800 shadow-sm transition-colors file:border-0 file:bg-transparent 
          file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground 
          focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-grayneutral-400 
